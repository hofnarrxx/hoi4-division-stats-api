...
@Component
public class EquipmentUpgradeParser {
    public static List<EquipmentUpgrade> parseUpgrades(String input) {
        List<EquipmentUpgrade> upgradeList = new ArrayList<>();
        input = removeComments(input);

        String upgradeBlock = extractBlock("upgrades", input);
        Map<String, String> upgradeBlocks = splitTopLevelBlocks(upgradeBlock);

        for (Map.Entry<String, String> entry : upgradeBlocks.entrySet()) {
            String id = entry.getKey();
            String block = entry.getValue();
            EquipmentUpgrade eu = parseSingleUpgrade(id, block);
           upgradeList.add(eu);
        }
    ...
    private static EquipmentUpgrade parseSingleUpgrade(String id, String block) {
        EquipmentUpgrade eq = new EquipmentUpgrade(id);
